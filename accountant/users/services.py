...
def share_by_category(sh1, sh2, sh3):
    msg = []
    if sh1 < 10:
        msg.append(("Возможность для открытия своего дела",
        ...
        msg.append(("Возможность для повышенных инвестиций",
        ...
        msg.append(("Большой свободный капитал",
        ...
        msg.append(("Пониженные обязательные траты",
        ...
        msg.append(("Повышенные обязательные траты",
        ...
        msg.append(("От зарплаты к зарплате",
        ...
        msg.append(("Срочно необходимы дополнительные источники заработка",
    ...
    if sh2 < 10:
        ...
        msg.append(("Нужен отдых от отдыха",
    ...
    if sh3 == 0:
        ...
        msg.append(("Инвестиционный человек",
...
def search_expenses(search_list):
    if search_list is None:
        search_list = Record.objects.all().values_list(*values_list)
    expenses = 0
